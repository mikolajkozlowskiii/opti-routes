...
class TSPSolverGoogleORToolsTest {
    @InjectMocks
    private TSPSolverGoogleORTools tspSolver;
    ...
    public void test(){
        ...
        final int depot = 0;
        TSPInputData input = TSPInputData
                .builder()
                .indexOfDepot(depot)
                .distanceMatrix(distanceMatrix)
                .build();
        final TSPOutputData output = tspSolver.solve(input);
